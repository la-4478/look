...
<form id="searchForm">
    ...
    <label>대분류 <select id="categoryLcls"><option value="">-- 선택 --</option></select></label>
    <label>중분류 <select id="categoryMcls"><option value="">-- 먼저 대분류 선택 --</option></select></label>
    <label>소분류 <select id="categoryScls"><option value="">-- 먼저 중분류 선택 --</option></select></label>

    <label>키워드 <input type="text" id="keyword" placeholder="예: 호텔, 한식, 놀이공원 등"/></label>
