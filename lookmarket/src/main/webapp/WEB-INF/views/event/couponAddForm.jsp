...
<!--                 <option value="2">정액 할인 (₩)</option> -->
        ...
        <div class="form-group">
            ...
            <input type="number" id="promoMaxDiscount" name="promoMaxDiscount" min="0" value="0"/>
        </div>

        <div class="form-group">
            <label for="promoMinPurchase">최소 구매 금액</label>
            <input type="number" id="promoMinPurchase" name="promoMinPurchase" min="0" value="0" required />
        </div>
